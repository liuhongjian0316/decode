...
public class CRC16_2 {
     ...
     * @return
     */
    public static byte[] getstringToByte(String cmdContent, Boolean flag) {
        String content = cmdContent;
        if (flag) {
            content = content.replace(" ", "");
        }
        String str = "0123456789ABCDEF";
        char[] hexs = content.toUpperCase().toCharArray();
     ...
     * @param hasTrim
     */
    public static String crc16ToReverseHexString(String content, Boolean hasTrim) {
        Integer crc = CRC16_2.calcCrc16(CRC16_2.getstringToByte(content, hasTrim));
        String crc16 = crc.toHexString(crc).toUpperCase();
        int count = 4 - crc16.length();
        if (crc16.length() < 4) {
            for (int i = 0; i < count; i++) {
                crc16 = "0" + crc16;
            }
        }
        crc16 = crc16.substring(2, 4) + crc16.substring(0, 2);
        return crc16;
    }
    ...
    public static void main(String[] args) {
        // 01 10 00 02 02 00 04 00 00 00 00
        Integer crc = CRC16_2.calcCrc16(CRC16_2.getstringToByte("30 31 30 33 30 437 30 31 33 30 30 30 30 30 30 31 34 433 30 30 30 30 30 30 30 30 30 30 30 30 30 30 36 34 434 31 36 39 30 30 30 30", true));
